...
if __name__ == "__main__":
    ...
    DrawioSignalFlowRenderer(design).render(out_dir / "thor_uml_signalflow_objects.drawio")
    (out_dir / "thor_uml_signalflow_objects.json").write_text(design.to_json(), encoding="utf-8")

    print("Created thor_uml_signalflow_objects.drawio")
    print("Created thor_uml_signalflow_objects.json")
