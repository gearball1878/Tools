    ...
    def build_drawio(self):
        ...
        if path:
            try:
                ...
                BusContentsIniExporter(self.model).save(base.with_name(base.name + "_buscontents.ini"))
                QMessageBox.information(self, "Build complete", "draw.io, JSON, SysML2 and buscontents.ini were written.")
            except Exception as exc:
                self.error(exc)
